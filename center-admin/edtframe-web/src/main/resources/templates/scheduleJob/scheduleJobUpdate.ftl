            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="jobName" id="jobName" lay-verify="required" autocomplete="off"
                           placeholder="任务名称" class="layui-input" value="${scheduleJob.jobName!}">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label"><span
                ...
                <div class="layui-input-block">
                    <input type="text" name="jobGroup" id="jobGroup" lay-verify="required" autocomplete="off"
                           placeholder="任务分组" class="layui-input" value="${scheduleJob.jobGroup!}">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label"><span
                ...
                <div class="layui-input-block">
                    <input type="text" name="cronExpression" id="cronExpression" lay-verify="required"
                           autocomplete="off"
                           placeholder="表达式" class="layui-input" value="${scheduleJob.cronExpression!}">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label"><span
                ...
                <div class="layui-input-block">
                    <input type="text" name="beanName" id="beanName" lay-verify="required" autocomplete="off"
                           placeholder="类名称" class="layui-input" value="${scheduleJob.beanName!}">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label"><span
                ...
                <div class="layui-input-block">
                    <input type="text" name="methodName" id="methodName" lay-verify="required" autocomplete="off"
                           placeholder="方法名称" class="layui-input" value="${scheduleJob.methodName!}">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label"><span
                ...
                <div class="layui-input-block">
                    <input type="text" name="description" id="description" lay-verify="required" autocomplete="off"
                           placeholder="任务备注" class="layui-input" value="${scheduleJob.description!}">
                </div>
            </div>
...
<script type="text/javascript" src="${ctx}/static/js/scheduleJob/scheduleJob.update.js"></script>
</body>
</html>
