...
<div class="cus-fluid">
    <div class="layui-col-md12">
        <form class="layui-form" action="" id="form">
            ...
            <input type="hidden" id="rightsId" name="rightsId" value="${role.rightsId!}">
...
<script type="text/javascript" src="${ctx}/static/js/role/role.rights.js"></script>
